...
ricoveri AS (
	...
	WHERE
		...
		AND (vo.visit_end_date - vo.visit_start_date) > 1 { @cohort_id != -1 } ? {
...
proc_inv_omop AS (
	...
	FROM
		proc_inv_icd9
		JOIN @vocabulary_schema.concept_relationship cr ON proc_inv_icd9.concept_id = cr.concept_id_1
