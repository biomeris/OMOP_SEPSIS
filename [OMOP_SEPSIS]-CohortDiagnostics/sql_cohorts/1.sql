...
( 
  select concept_id from @vocabulary_database_schema.CONCEPT where concept_id in (132797,196236,37394658)

) I
) C UNION ALL 
SELECT 1 as codeset_id, c.concept_id FROM (select distinct I.concept_id FROM
( 
  select concept_id from @vocabulary_database_schema.CONCEPT where concept_id in (132736,433415,433417,438077,133691,433701,132797,40486631,40493038,40491523,40493039,40487059,40489908,40489912,442137,434275)

) I
) C UNION ALL 
SELECT 2 as codeset_id, c.concept_id FROM (select distinct I.concept_id FROM
( 
  select concept_id from @vocabulary_database_schema.CONCEPT where concept_id in (4305080,435517,435308,312940,197329,197320,432961,319049,444044,377845,432585,198571,380834,374032,372887,436093,376961,4181917,4120120,4029488,4337543,194990,2008006,441264,317109,318459,40321716,196236,201965,432870,443586,261881)
...
WHERE (C.condition_start_date >= DATEFROMPARTS(2020, 1, 1) and C.condition_start_date <= DATEFROMPARTS(2022, 12, 31))
